...
public static class FileContentTypeHelper
{
    ...
    {
        if (FileExtensionToContentTypeMapping.TryGetValue(Path.GetExtension(filePath), out var contentType))
        {
            return contentType;
        }
        return default;
    ...
    private static Dictionary<string, string> FileExtensionToContentTypeMapping = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
    {
        { ".323", "text/h323" },
        { ".3g2", "video/3gpp2" },
        { ".3gp2", "video/3gpp2" },
