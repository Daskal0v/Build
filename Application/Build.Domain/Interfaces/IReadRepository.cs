...
{
    /// <summary> Returns a boolean whether any entity exists or not. </summary>
    /// <returns>
    ...
    /// <summary>
    /// Returns a boolean that represents whether any entity satisfy the encapsulated query logic of
    /// the <paramref name="specification"/> or not.
    /// </summary>
    ...
    /// <summary> Finds first entity of <typeparamref name="T"/> from the database. </summary>
    /// <returns>
    /// A task that represents the asynchronous operation. The task result contains a <see
    /// cref="{T}"/> that contains first element from the input sequence.
    /// </returns>
    Task<T> FirstOrDefaultAsync (CancellationToken cancellationToken = default);

    /// <summary>
    /// Finds first entity of <typeparamref name="T"/>, that matches the encapsulated query logic of
    /// the <paramref name="specification"/>, from the database.
    /// </summary>
    /// <param name="specification"> The encapsulated query logic. </param>
    /// <returns>
    /// A task that represents the asynchronous operation. The task result contains a <see
    ...
    /// <summary> Finds all entities of <typeparamref name="T"/> from the database. </summary>
    /// <returns>
    /// A task that represents the asynchronous operation. The task result contains a <see
    ...
    /// <summary>
    /// Finds all entities of <typeparamref name="T"/>, that matches the encapsulated query logic of
    /// the <paramref name="specification"/>, from the database.
    /// </summary>
    /// <param name="specification"> The encapsulated query logic. </param>
    /// <returns>
